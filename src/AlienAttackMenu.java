...
public class AlienAttackMenu extends JFrame {
    ...
    public void readHighScores() {
        try {
            ...
            Scanner fileReader = new Scanner(new File("Alien-Attack/src/resources/hiscores.txt"));
    ...
    public void printHighScores() {
        try {
            FileWriter writer = new FileWriter("Alien-Attack/src/resources/hiscores.txt");
            for(int i=0; i<10; i++) {
